...
그림 6은 킨들 앱인데요, 컴퓨터 코드를 나타내는 글꼴이 맥북 화면인 그림 7에 견줘 너무 가늡니다. 그림 4의 도구 아이콘과 그림 6의 글꼴이 충분히 확대되지 못한 결과입니다. 서피스에서도 킨들 앱 대신 브라우저(클라우드 리더)로 똑같은 전자책을 펼치면 읽기가 더 좋습니다(그림 6). 킨들 앱보다 브라우저가 더 잘 코딩된 까닭이겠지요.
