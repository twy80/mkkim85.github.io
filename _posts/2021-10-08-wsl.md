...
<sup>[1](#footnote_1)</sup> <a name="footnote_1"></a>GUI를 위한 추가 설정은 윈도우 10에만 해당합니다. 윈도우 11에선 WSL가 GUI를 지원하기 때문입니다. 요컨대 윈도우 11에선 여기 나온 바와 같은 미세 조정이 필요 없습니다. (추가 프로그램 설치나 DISPLAY 환경 변수 설정 없이) 그냥 됩니다.
