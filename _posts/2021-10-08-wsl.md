...
(덧붙임) 윈도우 11에선 리눅스 GUI 환경도 쉽게 구성할 수 있다고 합니다. 다만, 제 PC가 오래돼 윈도우 11 업그레이드 대상이 아니라 제가 직접 테스트해보진 못했습니다. 윈도우 11로 업그레이드하는 게 불가능하진 않지만, 하드웨어적으로 무리가 될 수도 있겠다 싶어 일단은 윈도우 10에 머물기로 하였습니다. 위에서 말씀드린 대로 리눅스 GUI 없이도 윈도우 앱 등을 이용해 제가 원하는 작업은 할 수 있기도 해서요.
